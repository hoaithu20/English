...
__decorate([
    typeorm_1.Column({ name: 'is_true' }),
    __metadata("design:type", Boolean)
], Answer.prototype, "isTrue", void 0);
__decorate([
    typeorm_1.ManyToOne(() => question_entity_1.Question, (q) => q.answers),
    typeorm_1.JoinColumn({ name: 'question_id' }),
    __metadata("design:type", question_entity_1.Question)
], Answer.prototype, "question", void 0);
__decorate([
    typeorm_1.RelationId((a) => a.question),
    __metadata("design:type", Number)
